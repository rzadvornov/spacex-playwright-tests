...
Feature: SpaceX Company API
  ...
  Scenario: Retrieve core company information fields
    ...
    And the response should contain core fields: name, founder, founded, employees
  ...
  Scenario: All core company details are present and accurate
    ...
    And the response should contain links to website, flickr, and twitter

  @Regression @GET @Validation @Numeric
  Scenario Outline: All numeric fields for Company are present and positive
    When I make a GET request to "/company"
