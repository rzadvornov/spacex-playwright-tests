import { HeadingExpectation, FormElementExpectation, VisualElementExpectation, Requirement, LandmarkExpectation, DestinationInfo, NavigationLink, LayoutRequirement, SpacingRequirement, StyleRequirement, InteractiveState, CoreRequirement, CriticalContent, MetadataItem, SocialMediaTag, AssistiveTechRequirement, CoreValue, MobileAction, RequirementMetric, MediaTile, MissionTab, MissionMetric, StructureCheck, CoreElement, NavigationRequirement } from "../utils/types/Types";
...
export const parseFormElementExpectations = TypeSafeParser.createParser<FormElementExpectation>(
  ["Element Type", "Label Type", "Requirements"],
  "form element expectation"
);

export const parseVisualElementExpectations = TypeSafeParser.createParser<VisualElementExpectation>(
  ["Element Type", "Attribute Required", "Content Type"],
  "visual element expectation"
);
