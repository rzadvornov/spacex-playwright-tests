...
export class APIBaseFixture extends APIBase {
    ...
    public async makeGetRequest(_id: string | undefined): Promise<void> {
        console.error("APIBaseFixture.makeGetRequest should not be called. Use resource-specific APIs.");
    ...
    public async makePostRequest(_endpoint: string, _body: any): Promise<void> {
        console.error("APIBaseFixture.makePostRequest should not be called. Use resource-specific APIs.");
